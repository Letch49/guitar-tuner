...
// Lowered from 40.0 to match our -30 dB amplitude threshold so that quiet
// signals (unplugged electric guitar through mic) still trigger spectral
// analysis. PTrack's own harmonic checks (ptrackPt6) remain as quality gate.
private let MINAMPS = -30.0
